...
public struct AnsightChannel: Sendable, Codable, Hashable {
    ...
    public init(id: Int, name: String, color: String? = nil, unit: String? = nil, type: String = "custom") {
        self.id = id
        self.name = name
        self.color = color
        self.unit = unit
    ...
    public init(id: Int, name: String, colorHex: String?, unit: String?, type: String = "custom") {
        self.init(id: id, name: name, color: colorHex, unit: unit, type: type)
    }

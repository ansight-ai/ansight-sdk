...
The Flutter bridge plan lives in [IMPLEMENTATION_SPEC.md](IMPLEMENTATION_SPEC.md).
...
Then add `mavenLocal()` in the host Android project's repository list and let the plugin resolve:

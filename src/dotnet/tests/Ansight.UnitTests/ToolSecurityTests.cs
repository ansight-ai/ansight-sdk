...
public sealed class ToolSecurityTests
{
    public static TheoryData<ITool, ToolSecurityLevel, string> BuiltInTools => new()
    {
        ...
        { new QueryNodesTool(), ToolSecurityLevel.High, ToolSecurityImplications.InspectsUi },
        { new PerformActionTool(), ToolSecurityLevel.Critical, ToolSecurityImplications.MutatesRuntimeState },
        { new WaitForUiConditionTool(), ToolSecurityLevel.High, ToolSecurityImplications.InspectsUi },
        { new ShowOverlayTool(), ToolSecurityLevel.High, ToolSecurityImplications.MutatesRuntimeState },
        { new GetOverlayTool(), ToolSecurityLevel.High, ToolSecurityImplications.InspectsUi },
        { new QueryOverlaysTool(), ToolSecurityLevel.High, ToolSecurityImplications.MetadataDisclosure },
        { new UpdateOverlayTool(), ToolSecurityLevel.High, ToolSecurityImplications.MutatesRuntimeState },
        { new RemoveOverlayTool(), ToolSecurityLevel.High, ToolSecurityImplications.MutatesRuntimeState },
        { new ClearOverlaysTool(), ToolSecurityLevel.High, ToolSecurityImplications.MutatesRuntimeState },

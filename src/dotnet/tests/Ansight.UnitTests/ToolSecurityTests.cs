...
public sealed class ToolSecurityTests
{
    public static TheoryData<ITool, ToolSecurityLevel, string> BuiltInTools => new()
    {
        ...
        { new ShowOverlayTool(), ToolSecurityLevel.Critical, ToolSecurityImplications.MutatesRuntimeState },
        ...
        { new UpdateOverlayTool(), ToolSecurityLevel.Critical, ToolSecurityImplications.MutatesRuntimeState },
        { new RemoveOverlayTool(), ToolSecurityLevel.Critical, ToolSecurityImplications.MutatesRuntimeState },
        { new ClearOverlaysTool(), ToolSecurityLevel.Critical, ToolSecurityImplications.MutatesRuntimeState },

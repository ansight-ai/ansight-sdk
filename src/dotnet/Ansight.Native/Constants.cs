...
/// <summary>
/// Common constants used across the Ansight runtime and UI.
/// </summary>
public static class Constants
{
    ...
    public static readonly Color BrandColor = new Color(250, 67, 31);
    
    public static readonly Color BrandColor_Faded = new Color(250, 67, 31).WithAlpha(0.8f);

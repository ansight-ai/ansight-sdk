...
/// </summary>
internal sealed class NativeChartViewAndroid : SKCanvasView
{
    ...
    public NativeChartViewAndroid(Context context) : base(context)
    {
    ...
    private void HandleMetricsUpdated(object? sender, MetricsUpdatedEventArgs e) => Invalidate();

    private void HandleEventsUpdated(object? sender, AppEventsUpdatedEventArgs e) => Invalidate();

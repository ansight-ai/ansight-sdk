...
dependencies {
    ...
    implementation("ai.ansight:ansight-tools-filedescriptordiagnostics-android:1.4.0-preview.1")
    implementation("ai.ansight:ansight-tools-jnireferencediagnostics-android:1.4.0-preview.1")

...
```kotlin
dependencies {
    implementation("ai.ansight:ansight-android:1.3.0-preview.4")
}
```
...
```kotlin
dependencies {
    implementation("ai.ansight:ansight-core-android:1.3.0-preview.4")
    implementation("ai.ansight:ansight-pairing-android:1.3.0-preview.4")
    implementation("ai.ansight:ansight-tools-filedescriptordiagnostics-android:1.3.0-preview.4")
    implementation("ai.ansight:ansight-tools-visualtree-android:1.3.0-preview.4")
}
```

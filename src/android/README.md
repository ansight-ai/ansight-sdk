...
```kotlin
dependencies {
    implementation("ai.ansight:ansight-android:1.4.0-preview.2")
}
```
...
```kotlin
dependencies {
    implementation("ai.ansight:ansight-core-android:1.4.0-preview.2")
    implementation("ai.ansight:ansight-pairing-android:1.4.0-preview.2")
    implementation("ai.ansight:ansight-tools-filedescriptordiagnostics-android:1.4.0-preview.2")
    implementation("ai.ansight:ansight-tools-jnireferencediagnostics-android:1.4.0-preview.2")
    implementation("ai.ansight:ansight-tools-visualtree-android:1.4.0-preview.2")
}
```

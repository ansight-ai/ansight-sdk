...
native Android apps. The SDK captures screenshots, visual trees, touches, logs,
...
```kotlin
dependencies {
    implementation("ai.ansight:ansight-android:1.6.1")
}
```
...
```kotlin
dependencies {
    implementation("ai.ansight:ansight-core-android:1.6.1")
    implementation("ai.ansight:ansight-pairing-android:1.6.1")
    implementation("ai.ansight:ansight-tools-filedescriptordiagnostics-android:1.6.1")
    implementation("ai.ansight:ansight-tools-jnireferencediagnostics-android:1.6.1")
    implementation("ai.ansight:ansight-tools-visualtree-android:1.6.1")
}
```
